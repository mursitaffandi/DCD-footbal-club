 ...
 */
class ClubViewHolder (val view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun bindItem(data: Team, listener: (Team) -> Unit) {
        nameClub.text = data.strTeam
        Glide.with(view).load(data.strTeamBadge).into(badgeClub)
